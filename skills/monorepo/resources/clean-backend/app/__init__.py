...
from app.utils.logging_config import setup_logging, get_access_logger
from app.utils.rate_limit import get_limiter, rate_limit_exceeded_handler, RATE_LIMIT_RULES
from slowapi.errors import RateLimitExceeded
from app.api.tool import router as tool_router
from app.api.health import router as health_router
from app.api.tool_category import router as category_router
from app.api.tool_import import router as import_router
...
setup_logging(
    ...
    enable_console_logging=settings.LOG_ENABLE_CONSOLE,
